...
func init() {
	locpool.Resources["en"] = map[string]string{
		...
		"commands.hide.description":                                       "exclude an alias from all listings",
		"commands.hide.fields.alias":                                      "Enter an alias",
		"commands.hide.status.failure":                                    fmt.Sprintf(trStatusFailureTemplateEn, "hiding the alias"),
		"commands.hide.status.no.rows":                                    "The alias doesn't exist",
	...
	locpool.Resources["ru"] = map[string]string{
		...
		"commands.hide.description":                                       "скрыть алиас из отображения в списках",
		"commands.hide.fields.alias":                                      "Введите алиас",
		"commands.hide.status.failure":                                    fmt.Sprintf(trStatusFailureTemplateRu, "скрытии алиаса"),
		"commands.hide.status.no.rows":                                    "Алиаса не существует",
