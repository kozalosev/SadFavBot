...
func init() {
	locpool.Resources["en"] = map[string]string{
		...
		"commands.save.fields.object.validation.error.forbidden.symbols": "the following symbols are forbidden for use: `%s` (+ new line character)",
	...
	locpool.Resources["ru"] = map[string]string{
		...
		"commands.save.fields.object.validation.error.forbidden.symbols": "следующие символы не могут быть использованы для названия: `%s` (+ перенос строки)",
