...
func init() {
	locpool.Resources["en"] = map[string]string{
		...
		"commands.install.status.failure":					   fmt.Sprintf(trStatusFailureTemplateEn, "installing package"),
