...
func init() {
	locpool.Resources["en"] = map[string]string{
		...
		"commands.link.status.duplicate.alias":                            "An alias with the same name already exists",
		"commands.link.status.no.alias":                                   "You're trying to link a non-existing alias",
	...
	locpool.Resources["ru"] = map[string]string{
		...
		"commands.link.status.duplicate.alias":                            "Закладка с таким названием уже существует",
