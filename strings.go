...
func init() {
	locpool.Resources["en"] = map[string]string{
		...
		"commands.save.status.success":                                    "Your fav was saved successfully!\nType `@%s %s` in any chat to use it",
		...
		"commands.package.fields.name":                                    "Enter a name for your package",
	...
	locpool.Resources["ru"] = map[string]string{
		...
		"commands.package.fields.name":                                    "Введите название для пакета",
